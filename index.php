...
<body>
    <div class="container">
      ...
      <div class="from-row">
        <div class="col">
          <div class="image_container" align="center">
            ...
            <div><h1>Welcome to Blood Donation Club Management System</h1></div>
          </div>
        ...
        <div class="form-row mt-5">
          <div class="col-sm-6" align="center">
                ...
                <div class="col-sm-6 mt-3">
                  <p class="text-justify">Please, Login to Blood Donation Club Management System by using Your Email Addresss and Password.</p>
                </div>
            </div>
            <div class="col-sm-6">
                  <div class="form-group">
                      <label for="user_email">Your Email</label>
                      <input type="email" name="user_email" id="user_email" class="form-control" required="1">
                  </div>
                  <div class="form-group">
                      <label for="user_password">Your Password</label>
                      <input type="Password" name="user_password" id="user_password" class="form-control" required="1">
                  </div>
                  <div class="form-row mt-5">
                    <div class="col-sm-6">
      ...
      <div class="col mt-5 ml-3" align="right">
        <p>DESIGN AND DEVELOPED BY <b>MD. MILTON KHAN</b></p>
      </div>
    </div>
