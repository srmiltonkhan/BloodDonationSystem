    ...
    <ul class='nav-menu list-unstyled d-flex flex-md-row align-items-md-center float-right'>     
      <li class='nav-item dropdown'>
          ...
          <ul aria-labelledby='languages' class='dropdown-menu'>
            <li><a rel='nofollow' href='#' class='dropdown-item'><i class='fa fa-user'></i>My Profile</a></li>
            <li><a rel='nofollow' href='#' class='dropdown-item'><i class='fa fa-edit'></i>Change Password</a></li>
            <li>
